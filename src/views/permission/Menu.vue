      ...
      >
        ...
        <vxe-column title="操作" min-width="100">
          <template #default="scope">
            <el-button type="primary" text @click="handleCreate(scope.row.id)">
              添加规则
            </el-button>
...
import { getMenus, deleteMenu, updateMenuStatus } from "@/api/permission/menu";
import type { IMenu } from "@/api/types/menu";
